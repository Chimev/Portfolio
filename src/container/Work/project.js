...
export const project = [
  ...
  { id: 4, title: 'MFT-token', description: 'Crypto NGO', imgUrl: images.mft, url: 'https://mft-token.vercel.app/', tags: ['Web App'], stack: ['Nextjs', 'Typescript','TailwindCss, supabase'] },
